...
# [1, 1, 1, 6, 2, 2, 3]과 같은 리스트가 있을 수도 있습니다.
# (몇 개의 수가 여러 번 중복되어 있을 수도 있습니다.)
# 이러한 리스트에서 반복되는 요소를 찾아내려고 합니다
# 중복되는 어떠한 수 ‘하나’만 찾아내도 됩니다. 즉 [1, 1, 1, 6, 2, 2, 3]의
# 예시에서 1, 2를 모두 리턴하지 않고, 1 또는 2 하나만 리턴하게 하면 됩니다.

# 저번 과제에서는 사전을 정의해서 문제를 푸는 방법을 사용했는데요, 이번 과제에서는 두 가지의 제약이 있습니다.
# O(n) 이상의 공간을 사용할 수 없습니다. 즉 사전이나 리스트와 같이 인풋 리스트의
# 길이에 비례하는 공간 저장 도구를 사용할 수 없습니다!
