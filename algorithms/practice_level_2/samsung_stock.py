...
# max_profit은 파라미터로 일별 주식 가격이 들어 있는 리스트 stock_prices를 받고
# 최대 수익을 리턴합니다. 주식은 딱 한 번만 사고 한 번만 팝니다. 그리고 사는 당일에 팔 수는 없습니다.
#
# 하나의 예시로, 지난 6일간 삼송전자의 주식 가격이 이렇다고 가정합시다.
# max_profit([7, 1, 5, 3, 6, 4])
# 이 기간 동안 낼 수 있는 최대 수익은 얼마일까요?
# 둘째 날 1에 사서 다섯째 날 6에 팔면 총 5의 수익이 생깁니다.
#
# 또 다른 예시를 봅시다.
