# process_complaint 메소드는:
# 현재 접수 대기 중인 문의가 있으면 "{}님의 {} 문의 내용 접수 되었습니다. 담당자가 배정되면 {}로 연락드리겠습니다!"의 내용을 출력시키고
# 접수 대기중인 문의가 없으면 "더 이상 대기 중인 문의가 없습니다!"를 출력시킵니다.
# add_complaint 메소드는:
# 받아오는 파라미터를 이용해서 고객 센터 문의 인스턴스를 만들고 서비스 센터 인스턴스의 문의 대기 큐에 해당 문의를 추가시켜줍니다.
