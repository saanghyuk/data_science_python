...
# 리스트에 담겨있는 튜플들은 각각 하나의 수업을 나타냅니다. 각 튜플의 0번째 항목은 해당 수업의 시작 시간,
# 그리고 1 번 항목은 해당 수업이 끝나는 시간입니다. 예를 들어서 0번 인덱스에 있는 튜플값은 (4, 7)이니까, 해당 수업은 4교시에 시작해서 7교시에 끝나는 거죠.
...
def course_selection(course_list):
    ...
    # print(sorted_list)
    selected_list.append(sorted_list[0])
    for i in range(1, len(sorted_list)):
        if sorted_list[i][0] < selected_list[-1][1]:
            pass
        else:
...
print(course_selection([(4, 7), (2, 3), (1, 3), (8, 10), (5, 9), (2, 5), (13, 16), (9, 11), (1, 8)]))
