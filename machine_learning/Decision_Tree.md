...
​		![7_1](./resources/7_22.png)	**TIP: 분류 노드인 독감! 이게 계속 껴 있어야, 마지막이 분류 노드가 될때 까지 진행이 되지. 그게 아니면 계속해서 질문 노드만 고르게 됨. 지금 위 결정 		트리는 결국 해당 칸에서 마지막 제일 불순도 작은 놈이 분류노드가 될 때 까지 하고, 분류노드가 나오면 멈춘 거야.** 
